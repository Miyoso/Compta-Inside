...
const styles = {
  ...
  card: {
    ...
    borderRadius: 20,
    boxShadow: '0 8px 48px rgba(0,0,0,0.7), 0 0 40px rgba(224,64,251,0.08), inset 0 1px 0 rgba(224,64,251,0.1)',
  ...
  btn: {
    ...
    width: '100%',
    padding: '13px',
    background: 'linear-gradient(135deg, #8b21e0, #e040fb)',
    color: '#fff',
    border: 'none',
    borderRadius: 10,
    fontSize: 15,
    fontWeight: '700',
    cursor: 'pointer',
    boxShadow: '0 4px 24px rgba(224,64,251,0.5)',
    transition: 'all 0.2s',
    letterSpacing: '0.3px',
  },
  btnDisabled: {
