...
const S = {
  ...
  toast:       { position: 'fixed', top: 20, right: 20, zIndex: 9999, padding: '13px 22px', borderRadius: 12, color: '#fff', fontWeight: 600, fontSize: 14, boxShadow: '0 8px 32px rgba(0,0,0,0.6)', maxWidth: 380 },
  ...
  navCompany: { background: 'linear-gradient(135deg, #b020d0, #f060ff)', color: '#fff', padding: '4px 14px', borderRadius: 20, fontSize: 12, fontWeight: 800, letterSpacing: 0.4, boxShadow: '0 0 14px rgba(224,64,251,0.4)' },
  navRight: { display: 'flex', alignItems: 'center', gap: 14 },
  navUser:  { color: '#8060a0', fontSize: 13 },
  navBtn:   { padding: '7px 16px', background: 'rgba(224,64,251,0.08)', border: '1px solid rgba(224,64,251,0.22)', borderRadius: 9, cursor: 'pointer', fontSize: 13, color: '#c090e0', fontWeight: 500 },
  ...
  weekTotal: { marginBottom: 12, fontSize: 15, color: '#d0b8f8', fontWeight: 500 },
  ...
  cartEmpty: { color: '#5a4080', fontSize: 14, textAlign: 'center', lineHeight: 1.6, padding: '16px 0' },
  ...
  cartBadge:   { position: 'absolute', top: -8, right: -8, background: 'linear-gradient(135deg, #b020d0, #f060ff)', color: '#fff', borderRadius: '50%', width: 22, height: 22, fontSize: 11, fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center' },
  productName: { fontWeight: 700, fontSize: 13, color: '#f0e8ff', marginBottom: 3 },
  productCat:  { fontSize: 10, color: '#5a4080', marginBottom: 6 },
  productPrice:{ fontSize: 15, fontWeight: 700, color: '#e040fb' },
  ...
  cartItemName: { fontWeight: 600, fontSize: 14, color: '#f0e8ff', marginBottom: 8 },
  cartItemRow:  { display: 'flex', alignItems: 'center', gap: 8 },
  cartItemTotal:{ fontSize: 14, fontWeight: 700, color: '#e040fb', flex: 1, textAlign: 'right' },
  ...
  qtyVal: { width: 28, textAlign: 'center', fontSize: 14, fontWeight: 700, color: '#f0e8ff' },
  removeBtn: { background: 'none', border: 'none', color: '#5a4080', cursor: 'pointer', fontSize: 14, padding: '0 4px' },

  cartFooter: { borderTop: '1px solid rgba(224,64,251,0.12)', paddingTop: 14, display: 'flex', flexDirection: 'column', gap: 10 },
  cartTotalRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 15, color: '#d0b8f8' },
  cartTotalAmt: { fontSize: 20, fontWeight: 800, color: '#f0e8ff' },
  btnSubmit:  { width: '100%', padding: '12px', background: 'linear-gradient(135deg, #b020d0, #f060ff)', color: '#fff', border: 'none', borderRadius: 10, fontSize: 14, fontWeight: 700, cursor: 'pointer', boxShadow: '0 4px 18px rgba(224,64,251,0.4)' },
  btnClear:   { width: '100%', padding: '8px', background: 'none', color: '#5a4080', border: '1px solid rgba(224,64,251,0.18)', borderRadius: 8, fontSize: 13, cursor: 'pointer' },
  ...
  invoiceNum:  { fontWeight: 700, fontSize: 14, color: '#f0e8ff', marginRight: 10 },
  invoiceDate: { fontSize: 12, color: '#5a4080' },
  invoiceTotal:{ fontSize: 16, fontWeight: 800, color: '#e040fb' },
  invoiceToggle:{ fontSize: 12, color: '#5a4080' },
  invoiceItems:{ padding: '0 18px 14px', display: 'flex', flexDirection: 'column', gap: 6, borderTop: '1px solid rgba(224,64,251,0.08)' },
  invoiceItem: { display: 'flex', justifyContent: 'space-between', fontSize: 13, color: '#d0b8f8', paddingTop: 6 },

  // Salaire
  infoBox: { background: 'rgba(224,64,251,0.07)', border: '1px solid rgba(224,64,251,0.18)', borderRadius: 10, padding: '12px 16px', marginBottom: 20, fontSize: 14, color: '#c090e0' },
  ...
  cwStat:   { flex: 1 },
  cwStatLabel: { fontSize: 13, color: '#8060a0', marginBottom: 4 },
  cwStatValue: { fontSize: 26, fontWeight: 800, color: '#f0e8ff' },
  cwStatSub:   { fontSize: 12, color: '#5a4080', marginTop: 2 },
  ...
  input:      { width: '100%', padding: '11px 14px', border: '1.5px solid rgba(224,64,251,0.18)', borderRadius: 9, fontSize: 14, color: '#f0e8ff', background: '#0a061a', boxSizing: 'border-box', outline: 'none' },
  btnPrimary: { padding: '10px 20px', background: 'linear-gradient(135deg, #b020d0, #f060ff)', color: '#fff', border: 'none', borderRadius: 9, cursor: 'pointer', fontSize: 14, fontWeight: 700, width: '100%', boxShadow: '0 4px 18px rgba(224,64,251,0.4)' },
};
